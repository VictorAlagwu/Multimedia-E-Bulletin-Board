...
<div class="page" data-animsition-in="fade-in" data-animsition-out="fade-out">
        <div class="page-content">
          ...
          <div class="page-register-main">
            ...
            <p>Don't have account? Please go to <a href="{{route('register')}}">Sign Up</a></p>
  
            <form role="form" autocomplete="on" class="form-horizontal" method="POST" action="{{ route('login') }}">
                    {{ csrf_field() }}
